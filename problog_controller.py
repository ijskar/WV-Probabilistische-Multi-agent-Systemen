...
def endStateContainsQuery(querylessProgString, beginState, plan, toContainListString):
    """
    ...
    :param beginState: A string representing the begin state. This is a string containing a list of ProbLog facts, for example: "[table(a), table(e), table(g)]"
    :param plan: A string representing the plan. This is a string containing a list of actions, for example: "[moveToTable(d,c), moveFromBlockOn(c, b, e)]".
    :param toContainListString: A string representing the fact(s) that are queried for. It can be a string of a singular ProbLog fact, or a string containing a list of ProbLog facts,
    ...
    """
    query = "query(endStateContains(" + beginState +", " + plan +", " + toContainListString + ")).\n"
...
def intertwinePlans(plan1, plan2):
    ...
    :param plan1: A string representing the first plan. This is a string containing a list of actions, for example: "[moveToTable(d,c), moveFromBlockOn(c, b, e)]".
    :param plan2: A string representing the second plan. This is a string containing a list of actions, for example: "[moveToTable(d,c), moveFromBlockOn(c, b, e)]".
    :return: A string representing the resulting, intertwined plan. This is a string containing a list of actions, for example: "[moveToTable(d,c), moveFromBlockOn(c, b, e)]".
    """
